...
def on_receive_position(packet, interface, db_helper, public_channel_number, admin_channel_number):
    ...
    if is_fast_moving and is_high_altitude:
        ...
        if db_helper.is_aircraft(node):
            ...
            #message_sender.send_llm_message(interface, user_message, public_channel_number)
            message_sender.send_llm_message(interface, admin_message, admin_channel_number)
